...
// NewClient returns an IEC61850 client,default config and default asdu.ParamsWide params
...
func (sf *Client) recvLoop() {
	...
	for {
		rawData := make([]byte, 40)
		for rdCnt, length := startMark, endMark; rdCnt < length; {
